...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output', type=str, default='', metavar='PATH', help='output directory')
    parser.add_argument('-os', '--output_suffix', type=str, default='', metavar='PATH', help='output suffix for 2D detections')
    ...
    # metadata = suggest_metadata('h36m')
    metadata['video_metadata'] = {}
    
    output = {}
    file_list = glob(args.input + '/' + args.output_suffix + '.mp4.npz')
    for f in file_list:
    ...
    print('Saving...')
    np.savez_compressed(args.output + '/' + output_prefix_2d + args.output_suffix, positions_2d=output, metadata=metadata)
    print('Done.')